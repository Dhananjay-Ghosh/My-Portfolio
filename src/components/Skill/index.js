  ...
  return (
    <>
      <div className="container skill-page">
            ...
            <div className='column'>
              <div className='col1'>
                <div className='col'>
                  ...
                  <h4 style={{padding:'0px', margin:'0px'}}><span style={{color:'yellow'}}>Excellent in :</span> : C++</h4>
                  <h4 style={{padding:'0px', margin:'0px'}}><span style={{color:'yellow'}}>Good at :</span> : C, Java, Pyhton</h4>
                  <h4 style={{padding:'0px', margin:'0px'}}><span style={{color:'yellow'}}>Basic :</span> : C#, php</h4>
                  {/* <li>C/C++ Excellent</li>
                  <li>Java Good</li>
                  <li>Python Good</li>
                  <li>C# Basic</li>
        ...
        <img className='gif' alt='NotFound' src={GIF}></img>
        <img className='gif1' alt='NotFound' src={GIF}></img>
        <img className='gif2' alt='NotFound' src={GIF}></img>
      </div >
      <Loader type="pacman" />
    </>
  )
